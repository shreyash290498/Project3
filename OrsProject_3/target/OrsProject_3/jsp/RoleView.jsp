					...
					<div class="panel panel-default">
						...
						<div class="panel-body" align="center">
							...
							<div class="form-group" align="left">
								<label align="left" class="control-label text-info col-md-6">Name<font
								...
								<div class="col-md-12" style="margin-bottom: 30px;">
									...
									<label class="control-label text-danger" for="inputError1"><%=ServletUtility.getErrorMessage("name", request)%><span>&emsp;</span></label>
								</div>
							</div>
							<div class="form-group" align="left">
								...
								<div class="col-md-12" style="margin-bottom: 20px;">
									...
									<label class="control-label text-danger" for="inputError1"><%=ServletUtility.getErrorMessage("description", request)%><span>&emsp;</span></label>
								</div>
							</div>
							<br> <br>
