					...
					<div class="panel panel-default">
						...
						<div class="panel-body" align="center">
							...
							<div class="form-group" align="left">
								<label align="left" class="control-label text-info col-md-6">College
									Name<font color="red">*</font>
								</label>
								<div class="col-md-12" style="margin-bottom: 20px;">
									<div class="input-group ">
										<span class="input-group-addon"><i
											class="fa fa-university"></i></span> <input class="form-control"
											type="text" name="name"
							...
							<div class="form-group" align="left">
								<label align="left" class="control-label text-info col-md-6">Address<font
									color="red">*</font></label>
								<div class="col-md-12" style="margin-bottom: 20px;">
									<div class="input-group">
										<span class="input-group-addon"><i
											class="fa fa-address-card"></i></span> <input class="form-control"
							...
							<div class="form-group" align="left">
								<label align="left" class="control-label text-info col-md-6">City<font
									color="red">*</font></label>
								<div class="col-md-12" style="margin-bottom: 20px;">
									<div class="input-group">
										<span class="input-group-addon"><i
							...
							<div class="form-group" align="left">
								<label align="left" class="control-label text-info col-md-6">State<font
									color="red">*</font></label>
								<div class="col-md-12" style="margin-bottom: 20px;">
									<div class="input-group">
										<span class="input-group-addon"><i
							...
							<div class="form-group" align="left">
								<label align="left" class="control-label text-info col-md-6">Phone
								...
								<div class="col-md-12" style="margin-bottom: 20px;">
									...
									<label class="control-label text-danger" for="inputError1"><%=ServletUtility.getErrorMessage("phoneNo", request)%></label>
								</div>
							</div>
							<br> <br>
